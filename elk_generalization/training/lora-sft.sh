...
# Run your script
srun python /admin/home-alexmallen/elk-generalization/elk_generalization/training/run_sft.py --rank $args_rank --lora-rank 0  --method first #--standardize-templates
